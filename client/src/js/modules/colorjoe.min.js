...
!(function(e, n) {
							...
							: {
									...
									change: function(e) {
										d(
											e.elem,
											'left',
											o.x + e.cursor.x - u.x + 'px'
										),
											d(
												e.elem,
												'top',
												o.y + e.cursor.y - u.y + 'px'
											);
									},
									end: p
								}).begin,
			...
			e.exports = (function() {
						...
						[ 'red', 'green', 'blue', 'alpha' ],
						{
							hex: function() {
								var e = (65536 *
									...
									Math.round(255 * this._blue)).toString(
									16
								);
								return (
									'#' +
									'00000'.substr(0, 6 - e.length) +
									e
								);
							},
							hexa: function() {
				...
				return c
					...
					.use(function(t) {
						...
						t
							.installMethod('greyscale', e)
							.installMethod('grayscale', e);
					})
					.use(function(e) {
						e.use(r),
	...
	var r = {
		...
		y = function(r) {
			return (
				(e = u),
				(n = [ r.init, r.xy, r.z ]).map(e).filter(s).length !=
				n.length
